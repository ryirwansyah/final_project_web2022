	...
	<div class="row">
		<div class="col-12">
			...
			<form method="POST" action="<?= base_url('admin/post/update/'.$data->id) ?>" enctype="multipart/form-data">        <div class="card">
				<div class="card-body">
					...
					<div class="row">
						<div class="col-md-8">
							...
							<div class="mb-3">
								...
								<textarea id="konten" name="konten" placeholder="Place some text here" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $data->konten ?></textarea>
								<div class="valid-feedback">
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="mb-3">
								<div class="row">
									<div class="input-group">
										<img id="show-cover" class="img-thumbnail" alt="200x200" width="100%" src="<?= image($data->id) ?>" data-holder-rendered="true">
									</div>
								</div>
							</div>
							...
							<div class="mb-3">
								...
								<div class="row">
									<div class="input-group">
										...
										value="<?php echo $data->diterbitkan ?>" />
									</div>
									<div class="valid-feedback">
									</div>
								</div>
